...
2. **Analysis** — Each track is tested against 23 pattern types
...
| DELTA_WIDE | u32 values with i8/i16 deltas | 6 + (n-1)×dw bytes |
...
- [x] Rust implementation with 23 pattern types
