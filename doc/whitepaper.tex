...
\begin{tikzpicture}[scale=1.0]
  ...
  % Highlight one sector (single sector on Track 0, between sector lines)
  \fill[blue!20] (22.5:2.7) arc (22.5:67.5:2.7) -- (67.5:3.3) arc (67.5:22.5:3.3) -- cycle;
  \draw[blue!60, thick] (22.5:2.7) arc (22.5:67.5:2.7) -- (67.5:3.3) arc (67.5:22.5:3.3) -- cycle;
  \node[font=\footnotesize, blue] at (45:4.0) {byte $i$};
  % Center
  \fill (0,0) circle (0.05);
  % r and theta arrows from center, connected
  \draw[->, thick] (0,0) -- (45:3.0);
  \node[font=\footnotesize, anchor=south west] at (45:1.5) {$r$};
  \draw[->, thick] (0.8,0) arc (0:45:0.8);
  \node[font=\footnotesize] at (22:1.1) {$\theta$};
\end{tikzpicture}
