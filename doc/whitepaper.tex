...
\begin{tikzpicture}[scale=0.9]
  ...
  \foreach \r in {1.0, 1.6, 2.2, 2.8} {
    \draw[gray!60] (0,0) circle (\r);
  }
  % Track labels (outside)
  \node[font=\scriptsize, anchor=west] at (2.85,0.2) {Track 0};
  \node[font=\scriptsize, anchor=west] at (2.25,0.2) {Track 1};
  \node[font=\scriptsize, anchor=west] at (1.65,0.2) {Track 2};
  \node[font=\scriptsize, anchor=west] at (1.0,0.2) {Track 3};
  % Draw sector lines
  \foreach \angle in {0,45,...,315} {
    \draw[gray!30] (0,0) -- (\angle:3.0);
  }
  % Label sectors outside outer ring
  \foreach \s/\angle in {0/67.5, 1/22.5, 2/337.5, 3/292.5, 4/247.5, 5/202.5, 6/157.5, 7/112.5} {
    \node[font=\tiny] at (\angle:3.4) {S\s};
  }
  % Highlight one sector
  \fill[blue!20] (22.5:2.5) arc (22.5:67.5:2.5) -- (67.5:3.1) arc (67.5:22.5:3.1) -- cycle;
  \node[font=\tiny, blue] at (45:3.7) {byte $i$};
  % Center
  \fill (0,0) circle (0.05);
  % r arrow (below, not overlapping text)
  \draw[->, thick] (0,-0.1) -- (270:2.7) node[midway, right, font=\scriptsize] {$r$};
  % theta arc
  \draw[->, thick] (3.6,0) arc (0:40:3.6) node[midway, right, font=\scriptsize] {$\theta$};
\end{tikzpicture}
