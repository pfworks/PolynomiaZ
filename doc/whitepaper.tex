...
\begin{tikzpicture}[scale=0.9]
  ...
  \foreach \r/\label in {1.0/T3, 1.6/T2, 2.2/T1, 2.8/T0} {
    \draw[gray!60] (0,0) circle (\r);
  }
  % Track labels
  \node[font=\scriptsize] at (3.15,0) {Track 0};
  \node[font=\scriptsize] at (2.55,0) {Track 1};
  \node[font=\scriptsize] at (1.95,0) {Track 2};
  \node[font=\scriptsize] at (1.3,0) {Track 3};
  % Draw sector lines
  \foreach \angle in {0,45,...,315} {
    \draw[gray!30] (0,0) -- (\angle:3.0);
  }
  % Label sectors on outer track
  \foreach \s/\angle in {0/67.5, 1/22.5, 2/337.5, 3/292.5, 4/247.5, 5/202.5, 6/157.5, 7/112.5} {
    \node[font=\tiny] at (\angle:3.25) {S\s};
  }
  % Highlight one sector
  \fill[blue!20] (22.5:2.5) arc (22.5:67.5:2.5) -- (67.5:3.1) arc (67.5:22.5:3.1) -- cycle;
  \node[font=\tiny, blue] at (45:3.5) {byte $i$};
  % Center
  \fill (0,0) circle (0.05);
  % Axes
  \draw[->, thick] (0,0) -- (45:2.8) node[midway, above, font=\scriptsize] {$r$};
  \draw[->, thick] (3.5,0) arc (0:35:3.5) node[midway, right, font=\scriptsize] {$\theta$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.75, every node/.style={font=\small}]
  % Input
  \node[draw, minimum width=6cm, minimum height=1.2cm] (input) at (0,4) {Input Data};

  % Analyzer
  \node[draw, rounded corners, fill=gray!10, minimum width=4cm] (analyze) at (0,2.5) {Pattern Analyzer};

  % Platter 0
  \node[draw, rounded corners, fill=blue!10, minimum width=4.5cm, minimum height=2cm] (p0) at (-3.2,0) {};
  \node[font=\small\bfseries] at (-3.2, 0.7) {Platter 0 (Structured)};
  \node[font=\scriptsize, align=left] at (-3.2, -0.1) {Track 0: CONST(0xFF)\\Track 1: LINEAR(0, 1)\\Track 3: LINEAR\_WIDE(...)\\Meta: tracks 4-19 AllSame};

  % Platter 1
  \node[draw, rounded corners, fill=red!10, minimum width=4.5cm, minimum height=2cm] (p1) at (3.2,0) {};
  \node[font=\small\bfseries] at (3.2, 0.7) {Platter 1 (Raw)};
  \node[font=\scriptsize, align=left] at (3.2, -0.1) {Track 2: RAW (deflated)\\Track 20: RAW (deflated)\\Track 21: RAW (deflated)};

  % Arrows
  \draw[->, thick] (input) -- (analyze);
  \draw[->, thick] (analyze) -- (-3.2, 1.2) node[midway, left, font=\scriptsize] {patterns found};
  \draw[->, thick] (analyze) -- (3.2, 1.2) node[midway, right, font=\scriptsize] {no pattern};
\end{tikzpicture}
