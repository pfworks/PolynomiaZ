...
\begin{tikzpicture}[scale=1.0]
  ...
  % Track labels (right side, staggered vertically to avoid overlap)
  \node[font=\footnotesize, anchor=west] at (3.1, 0.3) {Track 0};
  \node[font=\footnotesize, anchor=west] at (2.5, -0.3) {Track 1};
  \node[font=\footnotesize, anchor=west] at (1.9, 0.3) {Track 2};
  \node[font=\footnotesize, anchor=west] at (1.3, -0.3) {Track 3};
  % Draw sector lines
