...
\begin{tikzpicture}[scale=1.0]
  ...
  % r arrow (pointing down, clear of labels)
  \draw[->, thick] (0,0) -- (0,-2.9);
  \node[font=\footnotesize, anchor=west] at (0.1,-1.5) {$r$};
  % theta arc (top right, clear)
  \draw[->, thick] (3.8,0) arc (0:40:3.8);
  \node[font=\footnotesize] at (20:4.2) {$\theta$};
\end{tikzpicture}
